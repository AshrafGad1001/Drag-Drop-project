...
var _ValidationHelpers = require("utils/Validation/ValidationHelpers.js");
...
var Fields = exports.Fields = /*#__PURE__*/function (_Base) {
  ...
  return _createClass(Fields, [{
    ...
    key: "_handelAddProject",
    value: function _handelAddProject(e) {
      e.preventDefault();
    ...
    key: "_validationInputValues",
    value: function _validationInputValues(titleValue, descValue) {
      var _AssignValidateInputs = (0, _ValidationHelpers.AssignValidateInputs)(titleValue, descValue),
      ...
      var titleErrorMsg = (0, _ValidationHelpers.handleValidationErrors)(titleInputRule);
      var descErrorMsg = (0, _ValidationHelpers.handleValidationErrors)(descInputRule);
      if (titleErrorMsg.length) alert(titleErrorMsg);else if (descErrorMsg) alert(descErrorMsg);
      return true;
    }
  }]);
}(_Base2.Base);