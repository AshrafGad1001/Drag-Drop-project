...
var projectList = exports.projectList = /*#__PURE__*/function (_Base) {
  function projectList(private _status) {
    var _this;
    _classCallCheck(this, projectList);
    _this = _callSuper(this, projectList, ["project-list", "app", "".concat(_status, "-projects"), false]);
    _this.renderProjectList();
    return _this;
  }
  _inherits(projectList, _Base);
