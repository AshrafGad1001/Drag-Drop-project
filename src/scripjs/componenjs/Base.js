...
var Base = exports.Base = /*#__PURE__*/function () {
  function Base(private _templateId, private _hostId, private _elementId, private _positionElementStart) {
    ...
    var _this$_targetElement = this._targetElement(this._templateId, this._hostId),
      _this$_targetElement2 = _slicedToArray(_this$_targetElement, 2),
      template = _this$_targetElement2[0],
      _ = _this$_targetElement2[1];

    // Import Template Content
    var _templateContent = document.importNode(template.content, true);
  ...
  return _createClass(Base, [{
    key: "_targetElement",
    value: function _targetElement(TemplateId, hostId) {
